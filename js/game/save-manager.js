...
(function () {
    ...
    Game.prototype.load_game = function () {
        ...
        {
            this.mancala.current_store = parseInt(localStorage.getItem('current_store'));   //store is the score of player
            this.mancala.other_store = parseInt(localStorage.getItem('other_store'));

            this.mancala.current_pits = JSON.parse(localStorage.getItem('current_pits'));   //pit is the place where stone are present
